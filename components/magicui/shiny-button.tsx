...
const ShinyButton = ({
  ...
  return (
    ...
    >
      <span
        className="relative flex items-center justify-center block h-full w-full text-sm uppercase tracking-wide text-[rgb(0,0,0,65%)] dark:font-light dark:text-[rgb(255,255,255,90%)]"
        style={{
          maskImage:
