...
const ShinyButton = ({
  ...
  return (
    ...
    >
      <span
        className="relative flex items-center justify-start tracking-widest indent-9 h-full w-full text-sm uppercase  text-[rgb(0,0,0,65%)] dark:font-light dark:text-[rgb(255,255,255,90%)]"
        style={{
          maskImage:
